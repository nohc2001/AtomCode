...
"ADC Eb, Gb",//10   캐리플레그에 영향을 주는 더하기
"ADC Ev, Gv",
"ADC Gb, Eb",
"ADC Gv, Ev",
"ADC AL, lb",
...
"PUSH SS^i64",
"POP SS^i64",
"SBB Eb, Gb",//18   결과가 음수일때 캐리플래그영향주는 빼기
"SBB Ev, Gv",
"SBB Gb, Eb",
"SBB Gv, Ev",
"SBB AL, lb",
...
"POP rSI/r14",
"POP rDI/r15",
"PUSHA^i64 / PUSHAD^i64", //60 모든 범용레지스터를 스택에 푸시한다.
"POPA^i64 / POPAD^i64", //61 스택에 저장된 범용레지스터값을 로드
"BOUND^i64 Gv, Ma", //62 ?? 경계를 기준으로 배열 인덱스 검사
...
"JO Jb", // 70 jumps -> 뒤에 "opcode에 CB가 붙는다."
"JNO Jb",
"JB/JNAE/JC Jb",
"JNB/JAE/JNC Jb",
"JZ/JE Jb",
...
char TwoByteOpcode_DecodingTable[256][32] = {
	...
	"Unallocated",
	"GETSEC",
	"3byteEscapeA4", // 3byte opcode table A-4로 가기
	"Unallocated",
	"3byteEscapeA5", // 3byte opcode table A-5로 가기
	"Unallocated",
	"Unallocated",
	"Unallocated",
	"Unallocated",
...
char TwoByteOpcode_DecodingTable__[256][32] = {
	...
	"VMOVUPS Vps, Wps",//10
	"VMOVUPS Wps, Vps",
	"VMOVLPS Vq, Hq, Mq", // VMOVHLPS Vq, Hq, Uq 도 됨
	"VMOVLPS Mq, Vq",
	"VUNPCKLPS Vx, Hx, Wx",
	"VUNPCKHPS Vx, Hx, Wx",
	"VMOVHPS Vdq, Hq, Mq",
