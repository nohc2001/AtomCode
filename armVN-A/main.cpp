...
enum class op_type{
  ...
  Load_or_Store_AdvancedSIMD_SingleStructure_PostIndexed,
  Load_or_Store_MemoryTags,
  Load_or_Store_ExclusivePair,
  Load_or_Store_ExclusiveRegister,
  Load_or_Store_Ordered,
  Load_or_Store_CompareAndSwap,
  Load_or_Store_UnScaledImmediate_LDAPR_STLR,
  Load_or_Store_LoadRegister_Literal,
  Load_or_Store_MemoryCopyAndMemorySet,
  Load_or_Store_NoAllocatePair_Offset,
  Load_or_Store_RegisterPair_PostIndexed,
  Load_or_Store_RegisterPair_Offset,
  Load_or_Store_RegisterPair_PreIndexed,
  Load_or_Store_Register_UnScaledImmediate,
  Load_or_Store_Register_Immediate_PostIndexed,
  Load_or_Store_Register_UnPrivileged,
  Load_or_Store_Register_ImmediatePreIndexed,
  Load_or_Store_AtomicMemoryOperations,
  Load_or_Store_Register_RegisterOffset,
  Load_or_Store_Register_Pac,
  Load_or_Store_Register_UnsignedImmediate,
